defmodule ControlKeel.Agent.Adapters.Registry do
  @moduledoc false
  ...
  @modules [
    ControlKeel.Agent.Adapters.ClaudeCode,
    ControlKeel.Agent.Adapters.Augment,
    ControlKeel.Agent.Adapters.CodexCLI,
    ControlKeel.Agent.Adapters.Copilot,
    ControlKeel.Agent.Adapters.OpenCode,
    ControlKeel.Agent.Adapters.Pi,
    ControlKeel.Agent.Adapters.VSCode
  ]
