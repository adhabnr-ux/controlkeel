defmodule ControlKeelWeb.DeploymentComponents do
  ...
  def deploy_modal(assigns) do
    ...
    >
      ...
      <div class="relative my-8 w-full max-w-5xl mx-4 rounded-3xl border bg-card p-6 space-y-6 shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
        <button
          type="button"
          class="absolute top-4 right-4 text-muted-foreground hover:text-foreground transition cursor-pointer"
        ...
        <% else %>
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <article class="rounded-2xl border bg-card p-4">
              <p class="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Detected stack</p>
              <p class="mt-1.5 text-xl font-semibold text-foreground/90">
                {String.capitalize(to_string(@analysis.stack))}
              </p>
            </article>
            <article class="rounded-2xl border bg-card p-4">
              <p class="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Monthly cost range</p>
              <p class="mt-1.5 text-xl font-semibold text-foreground/90">
                ${@analysis.monthly_cost_range.low} - ${@analysis.monthly_cost_range.high}
              </p>
            </article>
            <article class="rounded-2xl border bg-card p-4">
              <p class="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Compatible platforms</p>
              <p class="mt-1.5 text-xl font-semibold text-foreground/90">
                {length(@analysis.platforms)}
              </p>
            </article>
            <article class="rounded-2xl border bg-card p-4">
              <p class="text-xs font-semibold uppercase tracking-[0.14em] text-muted-foreground">Files to generate</p>
              <p class="mt-1.5 text-xl font-semibold text-foreground/90">
