defmodule ControlKeelWeb.SessionComponents do
  ...
  def session_observability_section(assigns) do
    ...
    <div
      ...
      class="border border-[var(--ck-stroke)] rounded-[1.5rem] backdrop-blur-[18px] shadow-[0_24px_80px_rgba(0,0,0,0.22)] p-6 space-y-8"
    >
