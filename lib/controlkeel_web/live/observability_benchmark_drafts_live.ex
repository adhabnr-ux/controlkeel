  ...
  def render(assigns) do
    ...
    >
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-xl font-semibold text-[var(--primary)]">Benchmark drafts</h1>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div
          ...
          class="rounded-xl p-4 border border-[var(--border)] bg-[rgba(255,255,255,0.015)] space-y-1"
        >
          <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">Suites</p>
          <p class="text-lg font-semibold text-[var(--foreground)]">
      ...
      <div id="observability-benchmark-drafts-list" class="space-y-3">
        ...
        <%= if @drafts.drafts == [] do %>
          <p class="text-[var(--muted-foreground)] text-sm">No benchmark drafts yet.</p>
        <% else %>
            ...
            >
              <div class="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p class="text-sm font-semibold text-[var(--foreground)]">{draft.title}</p>
                </div>
                <span class={neutral_pill_class()}>{draft.status}</span>
              </div>
              <p class="text-sm text-[var(--foreground)] leading-relaxed">{draft.scenario_prompt}</p>
              ...
              <div class="flex items-center gap-3 pt-1">
                <button
                  ...
                  type="button"
                  class="inline-flex items-center rounded-lg px-3 py-1.5 text-sm font-semibold bg-[rgba(190,242,100,0.14)] text-[var(--primary)] border border-[var(--primary)] hover:opacity-80 transition-opacity"
                ...
                <button
                  ...
                  type="button"
                  class="inline-flex items-center rounded-lg px-3 py-1.5 text-sm font-semibold border border-[var(--border)] bg-[rgba(255,255,255,0.03)] text-[var(--foreground)] hover:opacity-80 transition-opacity"
