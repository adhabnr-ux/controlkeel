  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-background text-foreground">
      <div class="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div class="absolute right-0 top-1/4 h-72 w-72 rounded-full bg-info/10 blur-2xl" />
      </div>
      ...
      <section class="relative z-10 mx-auto flex min-h-screen w-full max-w-md flex-col justify-center px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex items-center justify-between">
          <.link
            href={~p"/"}
            class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.32em] text-muted-foreground transition duration-200 hover:text-primary"
          >
        ...
        <div class="overflow-hidden rounded-[2rem] border bg-card/95 p-8 shadow-[0_45px_120px_-40px_rgba(0,0,0,0.9)]">
          <div class="mb-8 text-center">
            <div class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-3xl border bg-muted shadow-[0_18px_48px_-30px_rgba(255,255,255,0.75)]">
            ...
            <p class="mt-3 text-sm text-muted-foreground">Sign in to continue to ControlKeel</p>
          </div>
          ...
          <p class="mt-7 text-center text-xs text-muted-foreground leading-6">
