  ...
  def render(assigns) do
    ...
    >
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-xl font-semibold text-[var(--primary)]">Imported snapshots</h1>
            ...
            >
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 gap-2 text-xs">
                <div>
                  ...
                  <p class="text-[var(--foreground)]">{imported.imported_at || "unknown time"}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Exported
                  </p>
                  <p class="text-[var(--foreground)]">{imported.exported_at || "unknown time"}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Session
                  </p>
                  <p class="text-[var(--foreground)]">#{imported.original_session_id || "unknown"}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Health
                  </p>
                  <p class="text-[var(--foreground)]">{imported.health}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Problem groups
                  </p>
                  <p class="text-[var(--foreground)]">{imported.problem_groups}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Findings
                  </p>
                  <p class="text-[var(--foreground)]">{imported.total_problem_findings}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Integrity
                  </p>
                  <p class="text-[var(--foreground)]">{imported.integrity_status}</p>
                </div>
                <div class="col-span-2">
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Fingerprint
                  </p>
                  <p class="text-[var(--foreground)] font-mono text-[10px] truncate">
                ...
                <div>
                  ...
                  <p class="text-[var(--foreground)]">{imported.mutation}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Schema
                  </p>
                  <p class="text-[var(--foreground)]">{imported.schema_version}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Source
                  </p>
                  <p class="text-[var(--foreground)]">{source_label(imported.source)}</p>
                </div>
                <div>
                  <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">
                    Redaction
                  </p>
                  <p class="text-[var(--foreground)]">{imported.redaction_policy || "unknown"}</p>
                </div>
              </div>
            </div>
          <% end %>
