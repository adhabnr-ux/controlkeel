    ...
    <section class="mx-auto w-[min(1180px,calc(100%-2rem))] pt-8 pb-16">
      ...
      >
        ...
        <div class="relative rounded-lg border border-white/10 bg-neutral-900 shadow-2xl p-6 w-full max-w-md mx-4">
          ...
          <textarea
            class="mt-4 w-full rounded-md border border-white/10 bg-black/40 px-4 py-3 text-sm text-white placeholder:text-slate-500 focus:border-primary focus:ring-2 focus:ring-[rgba(196,240,66,0.15)] focus:outline-none"
        ...
        <div class="relative rounded-lg border border-white/10 bg-neutral-900 shadow-2xl p-8 w-full max-w-2xl mx-4 space-y-4">
          ...
          <div class="flex items-center justify-between pt-2">
            <button
              ...
              type="button"
              class="rounded-md border border-primary bg-primary px-5 py-2 text-xs font-semibold uppercase tracking-[0.1em] text-black transition hover:brightness-110"
