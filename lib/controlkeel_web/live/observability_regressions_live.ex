  ...
  def render(assigns) do
    ...
    >
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-xl font-semibold text-[var(--primary)]">Regression tracking</h1>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <p class="text-[var(--muted-foreground)] text-xs">Window: {@regressions.days} day(s)</p>
        </div>
        <div
            ...
            >
              <div class="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p class="text-sm font-semibold text-[var(--foreground)]">Run #{run.id}</p>
                </div>
