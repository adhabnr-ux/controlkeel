  ...
  def render(assigns) do
    ...
    >
      <div class="flex items-start justify-between gap-4">
        <div>
          <h1 class="text-xl font-semibold text-[var(--primary)]">Trends</h1>
        ...
        <div class="flex items-center gap-3 shrink-0">
          <form id="trends-days" phx-change="select_days">
            <select
              name="days"
              class="border border-[var(--border)] rounded-full px-3 py-1.5 text-sm bg-[rgba(125,226,174,0.1)] text-[#d2ffe7] outline-none cursor-pointer appearance-none"
      ...
      <div class="text-[var(--muted-foreground)] text-xs">
        example: <span class="text-[var(--primary)]">controlkeel obs trends --days 30</span>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        >
          ...
          <p class="text-2xl font-semibold text-[var(--foreground)]">{@trends.totals.runs}</p>
        ...
        <div
          ...
          class="rounded-xl p-4 border border-[var(--border)] bg-[rgba(255,255,255,0.015)] space-y-1"
        >
          <p class="text-[var(--muted-foreground)] uppercase tracking-[0.1em] text-[10px]">Imports</p>
          <p class="text-2xl font-semibold text-[var(--foreground)]">{@trends.totals.imports}</p>
          <p class="text-[var(--muted-foreground)] text-xs">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3 max-h-[650px] overflow-y-auto">
          <%= for day <- @trends.series do %>
            ...
            >
              <p class="text-sm font-semibold text-[var(--foreground)]">{day.date}</p>
              <p class="text-[var(--muted-foreground)] text-xs">
